<?php
    ...
    /*
        ...
        execute the satement (run it!).

        use a fetch to pull the data from the statement/result object into PHP array.
        pull data fields from the array like: $row['product_name']
    ...
    */
    ...
    try {
        $sql = "SELECT product_name,product_description,product_price FROM productsDB;";
...
<body>
    ...
    <section>
        ...
        <div class="productBlock">
                ...
                <p class="productDe sc"><?php echo $result['product_description']; ?></p>
